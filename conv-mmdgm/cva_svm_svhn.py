...
def svm_cva(learning_rate=3e-4, n_epochs=10000, dirs = None, batch_size=500):
    ...
    classifier = Pegasos.Pegasos(input=x, rng=rng, n_in=4*4*96, n_out=10,  weight_decay=2e-6, loss=10)
...
if __name__ == '__main__':
    ...
    #if feature_type == 'one':
    svm_cva(dirs=dirs, learning_rate=learning_rate)
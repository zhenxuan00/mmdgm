...
class UnpoolConvNon_GauInit_DNN(object):
    """
    Unpool + conv + nonlinearity
    """

    def __init__(self, rng, filter_shape, image_shape, poolsize=(2, 2), border_mode='same', activation=None, mask=None, std=2e-2, cnorm=False):

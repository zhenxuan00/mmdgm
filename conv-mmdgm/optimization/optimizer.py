...
def get_simple_optimizer_min(learning_rate=0.01):
    print 'Simple', learning_rate.get_value()
    def get_optimizer(params, grads):
        updates = [
...
def get_momentum_optimizer_min(learning_rate=0.01, momentum=0.9, weight_decay=0.0):
    ...
    def get_optimizer(w, g):
        ...
        for i in xrange(len(w)):
            ...
            # Update moments
            mom_new = momentum * mom + learning_rate * (1 - momentum) * gi
            # Do update
            w_new = w[i] - mom_new
